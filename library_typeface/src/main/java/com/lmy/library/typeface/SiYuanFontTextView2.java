...
public class SiYuanFontTextView2 extends TextView {
    ...
    public SiYuanFontTextView2(Context context) {
        this(context, null);
    }

    public SiYuanFontTextView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SiYuanFontTextView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
